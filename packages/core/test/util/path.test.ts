...
import path, { dirname, basename, isAbsolute, resolve, relative, join, sep, posix } from "../../src/util/path.js";
import { moduleOf, isLocal, identitySanitizer } from "../../src/util/module-path.js";
