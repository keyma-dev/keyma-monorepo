...
import type { IRField, IRType } from "@keyma/ir";
import { irTypeToCpp, memberType, typeTag, valueBinding, irTypeGuard } from "../src/ir-type-to-cpp.js";

const field = (type: IRType, extra: Partial<IRField> = {}): IRField => ({
    name: "x", type, visibility: "public", readonly: false, required: true, validators: [], formatters: [], indexes: [],
