...
import { assignTags, stripTagHints, type RawTaggedField } from "../src/assign-tags.js";
...
function schema(name: string, fields: RawTaggedField[]): IRSchema {
    return { id: `schema:${name}`, name, sourceName: name, visibility: "public", fields, indexes: [], source: loc };
}
