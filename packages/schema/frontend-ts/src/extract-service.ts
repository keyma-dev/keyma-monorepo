...
import type { IRService, IRServiceMethod, IRDiagnostic } from "@keyma/core/ir";
import { mkError, KEYMA093, KEYMA094 } from "./diagnostics.js";
import { getLocation } from "@keyma/compiler/frontend-ts";
import { lowerSignature, type MethodLowerCtx } from "@keyma/compiler/frontend-ts";
